"""AI Security Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="AI/ML security agent that performs adversarial testing, model vulnerability assessment, data poisoning detection, model extraction prevention, and security hardening for deployed AI systems.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
