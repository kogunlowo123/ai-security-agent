"""Application configuration for AI Security Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="ai-security-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/ai_security_agent",
    ...
    opensearch_index: str = Field(default="ai_security_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="ai-security-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="ai-security-agent", description="A2A agent ID")
